...
[![GitHub release (latest SemVer including pre-releases)](https://img.shields.io/github/v/release/Jorengarenar/git-fmt-diff?include_prereleases&sort=semver&logo=semver)](https://github.com/Jorengarenar/git-fmt-diff/releases)
